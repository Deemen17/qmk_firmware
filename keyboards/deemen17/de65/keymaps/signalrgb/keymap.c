...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT_all(
        ...
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, DE_LIGHTING_CHANNEL_0_TOGGLE,          _______, 
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, RM_HUED, RM_HUEU,          RM_TOGG,           _______,
        _______,          _______, _______, _______, _______, QK_BOOT, _______, _______, _______, RM_SPDD, RM_SPDU, DE_LIGHTING_CHANNEL_1_TOGGLE,          RM_VALU, _______,  
