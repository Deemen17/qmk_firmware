...
#define MANUFACTURER LQT
#define PRODUCT      talice
...
#define MATRIX_COL_PINS { E2, B1, B3, F0, F1, F4, F5, F6, B7, D5, D7, D6, D3, D2, D4 }

        // "cols": ["E2", "B1", "B3", "F0", "F1", "F4", "F5", "F6", "B7", "D5", "D7", "D6", "D3", "D2", "D4"],
        // "rows": ["B4", "B5", "B6", "C6", "C7"]
